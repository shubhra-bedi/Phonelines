...
class Customer:
    ...
    def make_call(self, call: Call) -> None:
        ...
        """
        for phone_line_ in self._phone_lines:
            if call.src_number == phone_line_.get_number():
                phone_line_.make_call(call)
    ...
    def receive_call(self, call: Call) -> None:
        ...
        """
        for phone_line_ in self._phone_lines:
            if call.dst_number == phone_line_.get_number():
                phone_line_.receive_call(call)
